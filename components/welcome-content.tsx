      ...
      <Card className="bg-white/60 backdrop-blur-sm border-gray-200/50">
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-blue-50/80 rounded-lg hover:bg-blue-100/80 transition-colors cursor-pointer">
            ...
            <div className="p-4 bg-green-50/80 rounded-lg hover:bg-green-100/80 transition-colors cursor-pointer">
            ...
            <div className="p-4 bg-purple-50/80 rounded-lg hover:bg-purple-100/80 transition-colors cursor-pointer">
