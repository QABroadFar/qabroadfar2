...
For detailed information about the public access feature, see [Public Access Feature Documentation](PUBLIC_ACCESS_FEATURE_MD).
...
The application now uses Supabase PostgreSQL with the following key tables:
